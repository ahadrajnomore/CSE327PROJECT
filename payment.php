...
$post_data['success_url'] = "http://localhost/Medly/home.php";
$post_data['fail_url'] = "http://localhost/Medly/checkout.php";
$post_data['cancel_url'] = "http://localhost/Medly/checkout.php";
